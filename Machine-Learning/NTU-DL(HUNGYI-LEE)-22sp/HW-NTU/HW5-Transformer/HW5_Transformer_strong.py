# 修改get_rate函数+epoch改为30+transformer架构。
# 与medium baseline相比，将RNN架构改为Transoformer架构
# 模型的参数改变采用了Attention is all you need论文中的table3 base模型进行适当修改
# 因为我们的数据量不够，所以相对论文中的模型，降低了维度
import sys
import pdb
import pprint
import logging
